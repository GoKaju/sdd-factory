...
1. `sdd log summary N` and `sdd log show N`: phases, attempts, minutes, models, waits, review cycles, delegated gates, escalations. Numbers come from here; never estimate.
